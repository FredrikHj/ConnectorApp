...
/* Perferm the following tasks in the [PathForFilesFolder]:
    ...
    3 - Add        
            <1:1 varable´s
                ...
                />
*/
export default function AddTransactionsMordal () {
    ...
    }, [tableHeadLinesArr, tableCalcArr, dropDownListsObj, newAddedObj ]);
    ...
    //console.log(tableCalcCols[1]);
    //console.log(tableCalcArr[0]);
